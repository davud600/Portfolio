...
export default function Contact() {
  ...
  return (
    <motion.div
      ...
      <div
        className="pt-5 flex-row d-flex align-self-center"
        style={{
          width: contentWidth,
        }}>
        <p
      ...
      <div
        ...
        <a
          ...
          href="https://github.com/davud600"
          style={{
            height: '100%',
            fontSize: fontSize,
            color: PRIMARY_TEXT_COLOR,
      ...
      <div
        ...
        <a
          className="w-100 text-end"
          href="https://www.linkedin.com/in/dawud-gorqaj-89283b242/"
          style={{
            height: '100%',
            fontSize: fontSize,
            color: PRIMARY_TEXT_COLOR,
      ...
      <div
        ...
        <Form
          className="pt-5 align-self-center text-center"
          style={{
            width: contentWidth,
          }}>
          <Form.Group>
            <Form.Label
              className="display-4 fw-bold pb-5"
              style={{
